(function () {
    ...
    function userProfileService($http, $q, baseUrl, $sessionStorage, $window) {
    ...
    angular.module('AMApp').service('userProfileService', userProfileService);
    userProfileService.$inject = ['$http', '$q', 'baseUrl', '$sessionStorage', '$window'];
})();
